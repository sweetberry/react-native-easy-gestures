  ...
  onScale = ( event ) => {
    ...
    if (isObject || scalable) {
      ...
      if (!scalable.separate) {
        ...
        const increasedDistance2d = [currentDistance2d[0] - initialDistance2d[0],
          currentDistance2d[1] - initialDistance2d[1]];
        const diffDistance2d = [this.prevDistance2d[0] - increasedDistance2d[0],
          this.prevDistance2d[1] - increasedDistance2d[1]];
